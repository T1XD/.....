...
async function share(cookies, url, amount, interval) {
  ...
  async function sharePost() {
    try {
      const response = await axios.post(`https://graph.facebook.com/v21.0/me/feed?link=https://www.facebook.com/${id}&published=0&access_token=${accessToken}`, {}, {
        headers
      });
...
async function getAccessToken(cookie) {
  try {
    const headers = {
      'authority': 'https://business.facebook.com/',
